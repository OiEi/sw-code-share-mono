...
export const CodeEditor = ({ code, onCodeChange, pageSettings, currentTheme }: ICodeEditor) => {
    ...
    const renderLineNumbers = () => {
        ...
        return (
            <div
                className={`${currentTheme.editorBg} ${currentTheme.editorText} prism-${currentTheme.value}`}
                style={{
                    position: 'absolute',
                    left: '0.1rem',
                    top: '10px',
    ...
    return (
        <div style={{ position: 'relative' }} className={`${currentTheme.editorBg} ${currentTheme.editorText} prism-${currentTheme.value} rounded-b-2xl`}>
            {renderLineNumbers()}
